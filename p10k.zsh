# Generated by Powerlevel10k configuration wizard on 2022-02-04 at 23:15 CST.
...
# lightest, 24h time, angled separators, sharp heads, blurred tails, 2 lines, solid,
# no frame, compact, few icons, concise, instant_prompt=auto-quiet.
